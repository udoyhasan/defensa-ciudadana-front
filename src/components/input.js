           ...
           <div className="container m-3">   
                <div className="row">
                    ...
                    <div className="col-8 col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0">
                        <input onChange={sendingToParentComponent} ref={ref} placeholder={props.placeholder} type={props.type} className={`form-control float-left ${emptyInputAdvisor}`} data-customtype={props.customtype}  aria-label="" aria-describedby="basic-addon1"/>
                    </div>
                    <div className={`col-2 col-sm-2 col-md-2 col-lg-2 col-xl-2 p-0 ${(props.includeLoader)?"":"d-none"}`}>
